...
**Tech Stack:** Go • [HTMX](https://htmx.org/) • [templ](https://github.com/a-h/templ) • [SQLC](https://sqlc.dev/) • [Chi](https://github.com/go-chi/chi) • [Casbin](https://casbin.org/) • [OpenTelemetry](https://opentelemetry.io/)  
...
[**GitHub**](https://github.com/anomalousventures/tracks) • [**Documentation**](https://go-tracks.io)
...
- ✅ **Core CLI structure and project scaffolding** - Working
- 🚧 **Database layer with SQLC integration** - In progress
- 🚧 **Basic code generation patterns** - In progress
- 🚧 **TUI implementation** - Planned
- 🚧 **MCP server development** - Planned
- 📋 **Full feature set** - Planned and documented
...
*Want to follow along or contribute? Check out [Tracks on GitHub](https://github.com/anomalousventures/tracks) or dive into the [documentation](https://go-tracks.io). Got opinions? I'd love to hear them: find me on GitHub [@ashmortar](https://github.com/ashmortar) or drop into the discussions.*
...
*P.S. - Yes, I named it Tracks for the double meaning: Rails-inspired convention-over-configuration (the railroad kind) meets music production workflow (the DAW kind). As a bassist who codes, I couldn't resist. Yes, there will be both train puns and mix metaphors. No, I'm not sorry.* 🚂🎵
