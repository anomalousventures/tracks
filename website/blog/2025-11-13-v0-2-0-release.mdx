...
See the [CLI documentation](https://go-tracks.io/cli/new) for all available options.
...
- **[Getting Started Guide](https://go-tracks.io/getting-started/installation)** - Installation and setup
- **[Quickstart Tutorial](https://go-tracks.io/getting-started/quickstart)** - Create your first project in 15 minutes
- **[CLI Reference](https://go-tracks.io/cli/new)** - Complete command documentation
- **[Architecture Overview](https://go-tracks.io/guides/architecture-overview)** - Understand the generated project structure
