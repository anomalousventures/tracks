...
See the [CLI documentation](https://anomalousventures.github.io/tracks/cli/new) for all available options.
...
- **[Getting Started Guide](https://anomalousventures.github.io/tracks/getting-started/installation)** - Installation and setup
- **[Quickstart Tutorial](https://anomalousventures.github.io/tracks/getting-started/quickstart)** - Create your first project in 15 minutes
- **[CLI Reference](https://anomalousventures.github.io/tracks/cli/new)** - Complete command documentation
- **[Architecture Overview](https://anomalousventures.github.io/tracks/guides/architecture-overview)** - Understand the generated project structure

All documentation is available at [anomalousventures.github.io/tracks](https://anomalousventures.github.io/tracks/).
...
See the [full roadmap](https://anomalousventures.github.io/tracks/roadmap) for details on all planned phases.
