...
| Issue | Title | Scope |
|-------|-------|-------|
| [#529](https://github.com/anomalousventures/tracks/issues/529) | CLI infrastructure (db command + project detection) | Parent command, interfaces, project/db helpers |
| [#530](https://github.com/anomalousventures/tracks/issues/530) | tracks db migrate + rollback commands | --steps, --dry-run flags, unit tests |
| [#531](https://github.com/anomalousventures/tracks/issues/531) | tracks db status + reset commands | Status display, --force flag, confirmation |
| [#532](https://github.com/anomalousventures/tracks/issues/532) | Database CLI integration tests | E2E validation for all commands and drivers |
