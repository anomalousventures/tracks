...
12. ✅ **Create Lip Gloss theme system with color styles and NO_COLOR support** ([#14](https://github.com/anomalousventures/tracks/issues/14) | [PR #34](https://github.com/anomalousventures/tracks/pull/34))
