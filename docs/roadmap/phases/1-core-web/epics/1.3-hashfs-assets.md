...
> **⚠️ DEPRECATED:** This epic has been merged into [Epic 1.3: Asset Build & Serving Pipeline](./1.3-asset-pipeline.md). This document is kept for historical reference only.
>
> **Reason for Merge:** The original Epic 1.3 (HashFS Assets) and Epic 1.4 (Web Build Pipeline) were merged on 2025-11-19 to eliminate artificial boundaries between asset building and serving. The unified epic reduces complexity from 75 tasks to 62 tasks and provides a more cohesive asset pipeline.
>
> **See:** [1.3-asset-pipeline.md](./1.3-asset-pipeline.md) for the current unified epic.
